    ...
    Column(
        ...
        when (state.value) {
            ...
            is RegisterState.Error -> {
                Text(text = (state.value as RegisterState.Error).message)
            }
            ...
            is RegisterState.Loading -> {
                ...
                RegisterContent(
                    onSignClick = { email, password, name ->
...
@Composable
fun RegisterContent(onSignClick: (String, String, String) -> Unit, onSignInClick: () -> Unit = {}) {
    ...
    Column(
        ...
        Button(
            onClick = {
                onSignClick(email.value, password.value, name.value)
            },
            modifier = Modifier
                .padding(vertical = 8.dp)
                .fillMaxWidth(),
